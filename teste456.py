    ...
    if speech_recognition_result.reason == speechsdk.ResultReason.RecognizedSpeech:
        ...
        if speech_recognition_result.text == "Sair.":
            for a in teste:
                ...
                speech_config.speech_synthesis_voice_name=  myDictonary[detect(a)]
                speech_synthesizer.speak_text_async(a).get()
            done = True
        else:
            speech_config.speech_synthesis_voice_name= detectLang(speechsdk)
